...
var updateResources = function updateResources(payload, storeUpdater) {
  if (_isGraphQl(payload)) {
    ...
    Object.entries(graphQlNormalize(payload)).forEach(function (array) {
      ...
      } else if ((typeof storeUpdater === "undefined" ? "undefined" : _typeof(storeUpdater)) === "object") {
...
var updateResource = function updateResource(_ref7, dispatch) {
  var id = _ref7.id,
      type = _ref7.type,
...
var removeResource = function removeResource(_ref8, dispatch) {
  var id = _ref8.id,
      type = _ref8.type;
