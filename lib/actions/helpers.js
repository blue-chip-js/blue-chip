...
var isVuex = exports.isVuex = function isVuex(storeUpdater) {
  return storeUpdater.name === "boundCommit" || typeof storeUpdater.toString() === "string" && !!storeUpdater.toString().match(/boundCommit/);
};
