(function (global, factory) {
	...
	const updateResources$1 = (mutator, resourceType, resourcesById) => {
	...
	const removeResources$1 = (mutator, resources) => {
	  resources.forEach(({type, id}) => {
	    delete mutator[type][id];
	  });
	};

	const removeResource$1 = (mutator, {id, type}) => {
	  delete mutator[type][id];
	};

	const clearResources$1 = (mutator, resourceTypes) => {
	  resourceTypes.forEach(resourceType => {
	    mutator[resourceType] = {};
	  });
	};
	...
	var actions$1 = /*#__PURE__*/Object.freeze({
		updateResources: updateResources$1,
		updateResource: updateResource$1,
		removeResources: removeResources$1,
		removeResource: removeResource$1,
		clearResources: clearResources$1
	});

	var index$1 = {actions: actions$1};

	const updateResourcesSetState = (
	  mutator,
	  resourceType,
	  resourcesById
	) => {
	...
	const removeResources$2 = (mutator, resources) => {
	  console.log("Not Implemented Yet");
	};

	const removeResource$2 = (mutator, {id, type}) => {
	  console.log("Not Implemented Yet");
	};

	const clearResources$2 = (mutator, resourceTypes) => {
	  console.log("Not Implemented Yet");
	};

	var actions$2 = /*#__PURE__*/Object.freeze({
		updateResourcesSetState: updateResourcesSetState,
		updateResource: updateResource$2,
		removeResources: removeResources$2,
		removeResource: removeResource$2,
		clearResources: clearResources$2
	});

	var index$2 = {actions: actions$2};
	...
	const updateResources$2 = (mutator, resourceType, resourcesById) => {
	  mutator("UPDATE_RESOURCES", {resourceType, resourcesById});
	};

	const updateResource$3 = (
	  mutator,
	  {id, type, attributes, links, relationships}
	) => {
	  console.log("Not Implemented Yet");
	...
	const removeResources$3 = (mutator, resources) => {
	  console.log("Not Implemented Yet");
	};

	const removeResource$3 = (mutator, {id, type}) => {
	  console.log("Not Implemented Yet");
	};

	const clearResources$3 = (mutator, resourceTypes) => {
	  console.log("Not Implemented Yet");
	};

	var actions$3 = /*#__PURE__*/Object.freeze({
		updateResources: updateResources$2,
		updateResource: updateResource$3,
		removeResources: removeResources$3,
		removeResource: removeResource$3,
		clearResources: clearResources$3
	});

	var index$3 = {actions: actions$3, resourcesMutations};

	exports.Actions = Actions;
	exports.BaseModel = BaseModel;
	exports.vuexAdapter = index$3;
	exports.reduxAdapter = index;
	exports.mobxAdapter = index$1;
	exports.setStateAdapter = index$2;
