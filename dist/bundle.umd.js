...
<<<<<<< HEAD
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('graphql-normalizr'), require('.adapters/redux/resourcesReducer'), require('.adapters/mobx/resourcesMutations')) :
  typeof define === 'function' && define.amd ? define(['exports', 'graphql-normalizr', '.adapters/redux/resourcesReducer', '.adapters/mobx/resourcesMutations'], factory) :
  (factory((global.bundle = global.bundle || {}, global.bundle.js = {}),global.graphqlNormalizr,global.resourcesReducer,global.resourcesMutations));
}(this, (function (exports,graphqlNormalizr,resourcesReducer,resourcesMutations) { 'use strict';

  resourcesMutations = resourcesMutations && resourcesMutations.hasOwnProperty('default') ? resourcesMutations['default'] : resourcesMutations;
  ...
  exports.resourcesReducer = resourcesReducer.resourcesReducer;
...
=======
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('graphql-normalizr')) :
	typeof define === 'function' && define.amd ? define(['exports', 'graphql-normalizr'], factory) :
	(factory((global.bundle = global.bundle || {}, global.bundle.js = {}),global.graphqlNormalizr));
}(this, (function (exports,graphqlNormalizr) { 'use strict';

	graphqlNormalizr = graphqlNormalizr && graphqlNormalizr.hasOwnProperty('default') ? graphqlNormalizr['default'] : graphqlNormalizr;
	...
	var actions_1 = actions.updateResources;
	...
	var _immer = ( immer_module && produce ) || immer_module;

	var resourcesReducer_1 = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(resourcesReducer_1);
	...
	var redux = createCommonjsModule(function (module, exports) {
	  ...
	  var _resourcesReducer2 = _interopRequireDefault(resourcesReducer_1);
	  ...
	  exports.default = {
	    ...
	    resourcesReducer: _resourcesReducer2.default
	  };
	});

	unwrapExports(redux);

	var resourcesMutations = createCommonjsModule(function (module, exports) {
	  ...
	  exports.default = {
	    UPDATE_RESOURCES: function UPDATE_RESOURCES(state, _ref) {
	      var resourceType = _ref.resourceType,
	          resourcesById = _ref.resourcesById;

	      Object.entries(resourcesById).forEach(function (_ref2) {
	...
	unwrapExports(resourcesMutations);
	...
	var helpers = createCommonjsModule(function (module, exports) {
	  ...
	  var isRedux = exports.isRedux = function isRedux(mutator) {
	    return mutator.name === "dispatch" || typeof mutator.toString() === "string" && !!mutator.toString().match(/dispatch/);
	  };

	  var isMobx = exports.isMobx = function isMobx(mutator) {
	    return (typeof mutator === "undefined" ? "undefined" : _typeof(mutator)) === "object";
	  };

	  var isSetState = exports.isSetState = function isSetState(mutator) {
	    return typeof mutator === "function";
	  };

	  var isVuex = exports.isVuex = function isVuex(mutator) {
	    return mutator.name === "boundCommit" || typeof mutator.toString() === "string" && !!mutator.toString().match(/boundCommit/);
	  };
	  ...
	  var buildRelationships = exports.buildRelationships = function buildRelationships(resource) {
	...
	var helpers_1 = helpers.GraphQL;
	var helpers_2 = helpers.JsonAPI;
	var helpers_3 = helpers.isGraphQl;
	var helpers_4 = helpers.isRedux;
	var helpers_5 = helpers.isMobx;
	var helpers_6 = helpers.isSetState;
	var helpers_7 = helpers.isVuex;
	var helpers_8 = helpers.toJsonApiSpec;
	var helpers_9 = helpers.buildRelationships;

	var updateResource = createCommonjsModule(function (module, exports) {

	  Object.defineProperty(exports, "__esModule", {
	    value: true
	  });

	  exports.default = function (_ref, mutator) {
	    var id = _ref.id,
	        type = _ref.type,
	    ...
	    if ((0, helpers.isRedux)(mutator)) {
	      mutator({
	        ...
	        attributes: attributes,
	        links: links,
	        relationships: relationships || (0, helpers.buildRelationships)(type, attributes)
	      });
	    } else if ((0, helpers.isMobx)(mutator)) {
	      if (!(type in mutator)) {
	        mutator[type] = {};
	      }
	    ...
	    } else if ((0, helpers.isSetState)(mutator)) {
	      mutator(function (state) {
	        if (!(type in state.resources)) {
	          state.resources[type] = {};
	        }
	...
	unwrapExports(updateResource);

	var removeResources = createCommonjsModule(function (module, exports) {

	  Object.defineProperty(exports, "__esModule", {
	    value: true
	  });

	  exports.default = function (resources, mutator) {
	    if ((0, helpers.isRedux)(mutator)) {
	      mutator({
	        type: "REMOVE_RESOURCES_BY_ID",
	        resources: resources
	...
	unwrapExports(removeResources);

	var removeResource = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(removeResource);

	var clearResources = createCommonjsModule(function (module, exports) {

	  Object.defineProperty(exports, "__esModule", {
	    value: true
	  });

	  exports.default = function (resourceTypes, mutator) {
	    if ((0, helpers.isRedux)(mutator)) {
	      mutator({
	        type: "CLEAR_RESOURCES",
	...
	var Actions_1 = createCommonjsModule(function (module, exports) {
	  ...
	  var _jsonApiNormalizer2 = _interopRequireDefault(bundle);
	  ...
	  var Actions = function () {
	    ...
	    _createClass(Actions, [{
	      key: "updateResources",
	      value: function updateResources(spec, payload, mutator) {
	        var _this = this;

	        Object.entries((0, helpers.isGraphQl)(payload) ? graphQlNormalize(payload) : (0, _jsonApiNormalizer2.default)(payload)).forEach(function (_ref2) {
	          var _ref3 = _slicedToArray(_ref2, 2),
	              resourceType = _ref3[0],
	              resourcesById = _ref3[1];

	          var rById = (0, helpers.isGraphQl)(payload) ? (0, helpers.toJsonApiSpec)(resourceType, resourcesById) : resourcesById;

	          _this.adapter.updateResources(mutator, resourceType, rById);
	        });
	      }
	    }]);
	...
	var actions$2 = createCommonjsModule(function (module, exports) {

	  Object.defineProperty(exports, "__esModule", {
	    value: true
	  });
	  exports.Actions = exports.clearResources = exports.removeResource = exports.removeResources = exports.updateResource = undefined;

	  var _updateResource2 = _interopRequireDefault(updateResource);

	  var _removeResources2 = _interopRequireDefault(removeResources);

	  var _removeResource2 = _interopRequireDefault(removeResource);

	  var _clearResources2 = _interopRequireDefault(clearResources);
	  ...
	  exports.updateResource = _updateResource2.default;
	  exports.removeResources = _removeResources2.default;
	  exports.removeResource = _removeResource2.default;
	  exports.clearResources = _clearResources2.default;
	  exports.Actions = _Actions2.default;
	});

	unwrapExports(actions$2);
	var actions_1$1 = actions$2.Actions;
	var actions_2 = actions$2.clearResources;
	var actions_3 = actions$2.removeResource;
	var actions_4 = actions$2.removeResources;
	var actions_5 = actions$2.updateResource;
	...
	var Query_1 = createCommonjsModule(function (module, exports) {
	  ...
	  var _pluralize2 = _interopRequireDefault(pluralize);
	...
	unwrapExports(Query_1);

	var BaseModel_1 = createCommonjsModule(function (module, exports) {
	  ...
	  var _Query2 = _interopRequireDefault(Query_1);
	  ...
	  var BaseModel = function () {
	    _createClass(BaseModel, null, [{
	      ...
	      value: function query(resources) {
	        return new _Query2.default(this, (0, _pluralize2.default)(this.name.toLowerCase()), resources, this.hasMany, this.belongsTo);
	      }
	    }]);
	      ...
	      value: function _buildHasManyQuery(resource, resources, relationship) {
	        ...
	        if (!resource[relationshipKey]) {
	          resource[relationshipKey] = function () {
	            ...
	            return new _Query2.default(relationship, relationshipKey, newResouces, relationship.hasMany, relationship.belongsTo);
	          };
	        }
	      }
	    }]);
	...
	var lib = createCommonjsModule(function (module, exports) {
	  ...
	  var _redux2 = _interopRequireDefault(redux);

	  var _resourcesMutations2 = _interopRequireDefault(resourcesMutations);

	  var _BaseModel2 = _interopRequireDefault(BaseModel_1);

	  function _interopRequireDefault(obj) {
	    return obj && obj.__esModule ? obj : { default: obj };
	  }

	  exports.Actions = actions$2.Actions;
	  exports.updateResource = actions$2.updateResource;
	  exports.removeResource = actions$2.removeResource;
	  exports.removeResources = actions$2.removeResources;
	  exports.clearResources = actions$2.clearResources;
	  exports.resourcesReducer = redux.resourcesReducer;
	...
	var lib_1 = lib.reduxAdapter;
	var lib_2 = lib.BaseModel;
	var lib_3 = lib.mutations;
	var lib_4 = lib.resourcesReducer;
	var lib_5 = lib.clearResources;
	var lib_6 = lib.removeResources;
	var lib_7 = lib.removeResource;
	var lib_8 = lib.updateResource;
	var lib_9 = lib.Actions;

	exports.default = index$2;
	exports.reduxAdapter = lib_1;
	exports.BaseModel = lib_2;
	exports.mutations = lib_3;
	exports.resourcesReducer = lib_4;
	exports.clearResources = lib_5;
	exports.removeResources = lib_6;
	exports.removeResource = lib_7;
	exports.updateResource = lib_8;
	exports.Actions = lib_9;
