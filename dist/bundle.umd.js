(function (global, factory) {
	...
	function astFromValue(value, type) {
	  ...
	  if (isInputObjectType(type)) {
	    if (_value === null || (typeof _value === 'undefined' ? 'undefined' : _typeof$1(_value)) !== 'object') {
	      return null;
	    }
	...
	function getPromise(value) {
	  if ((typeof value === 'undefined' ? 'undefined' : _typeof$3(value)) === 'object' && value !== null && typeof value.then === 'function') {
	    return value;
	  }
	}
	...
	function assertValidExecutionArguments(schema, document, rawVariableValues) {
	  ...
	  !(!rawVariableValues || (typeof rawVariableValues === 'undefined' ? 'undefined' : _typeof$5(rawVariableValues)) === 'object') ? invariant(0, 'Variables must be provided as an Object where each property is a ' + 'variable value. Perhaps look to see if an unparsed JSON string ' + 'was provided.') : void 0;
	}
	...
	function defaultResolveTypeFn(value, context, info, abstractType) {
	  ...
	  if (value !== null && (typeof value === 'undefined' ? 'undefined' : _typeof$5(value)) === 'object' && typeof value.__typename === 'string') {
	...
	var defaultFieldResolver = function defaultFieldResolver(source, args, context, info) {
	  ...
	  if ((typeof source === 'undefined' ? 'undefined' : _typeof$5(source)) === 'object' || typeof source === 'function') {
	...
	const graphQLNormalizr = new es_1();
