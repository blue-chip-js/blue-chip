	  ...
	  _createClass$1(Query, [{
	    ...
	    value: function _reduceCurrentResources(reducerType) {
	      ...
	      return Object.values(currentResources).sort(function (resource1, resource2) {
	        ...
	        var newFormattedResource = conversion(_this.klass, resources, _extends$5({
	          id: id
	        }, attributes), hasMany, belongsTo);

	        if (!currentIncludes.length) return newFormattedResource;
	        return conversion(_this.klass, resources, _extends$5({}, newFormattedResource, _flattenRelationships(relationships).reduce(function (nextRelationshipObjects, _ref4) {
	          var id = _ref4.id,
	              type = _ref4.type;
	          ...
	          nextRelationshipObjects[type].push(conversion(relationClass, resources, _extends$5({
	            id: id
	...
	var BaseModel = function () {
	  _createClass$2(BaseModel, null, [{
	    ...
	    value: function query(resources) {
	      return new Query(this, lowerCaseFirst(pluralize(this.name)), resources, this.hasMany, this.belongsTo);
	    }
	  }]);
	  ...
	  function BaseModel(resources, attributes) {
	    ...
	    if (belongsTo.forEach) {
	      belongsTo.forEach(function (relationship) {
	        var relationshipKey = lowerCaseFirst(relationship.name);
	  ...
	  _createClass$2(BaseModel, [{
	    ...
	    value: function _filterResources(resource, resources, relationship, relationshipKey) {
	      ...
	      var currentResourceKey = lowerCaseFirst(pluralize(resource.constructor.name));
	    ...
	    value: function _buildHasManyQuery(resource, resources, relationship) {
	      var relationshipKey = lowerCaseFirst(pluralize(relationship.name));
