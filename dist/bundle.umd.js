(function (global, factory) {
	...
	var updateResources = createCommonjsModule(function (module, exports) {
	...
	exports.default = function (payload, storeUpdater) {
	  (0, helpers.isGraphQl)(payload) ? _updateResourcesByStateManger(helpers.GraphQL, payload, storeUpdater) : _updateResourcesByStateManger(helpers.JsonAPI, payload, storeUpdater);
	};

	var _updateResourcesByStateManger = function _updateResourcesByStateManger(spec, payload, storeUpdater) {
	  Object.entries(spec === helpers.GraphQL ? graphQlNormalize(payload) : (0, _jsonApiNormalizer2.default)(payload)).forEach(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 2),
	        resourceType = _ref2[0],
	        resourcesById = _ref2[1];

	    var rById = spec === helpers.GraphQL ? (0, helpers.toJsonApiSpec)(resourceType, resourcesById) : resourcesById;
	    if ((0, helpers.isRedux)(storeUpdater)) {
	      _updateResourcesRedux(storeUpdater, resourceType, rById);
	    } else if ((0, helpers.isMobx)(storeUpdater)) {
	      _updateResourcesMobx(storeUpdater, resourceType, rById);
	    } else if ((0, helpers.isVuex)(storeUpdater)) {
	      _updateResourcesVuex(storeUpdater, resourceType, rById);
	    } else if ((0, helpers.isSetState)(storeUpdater)) {
	...
	var _updateResources2 = _interopRequireDefault(updateResources);
	...
	exports.updateResources = _updateResources2.default;
	...
	var actions_1 = actions.clearResources;
	var actions_2 = actions.removeResource;
	var actions_3 = actions.removeResources;
	var actions_4 = actions.updateResource;
	var actions_5 = actions.updateResources;
	...
	exports.updateResources = actions.updateResources;
